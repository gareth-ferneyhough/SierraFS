...
{
    std::cout << "xmp_readdir, woo" << std::endl;
	DIR *dp;
	struct dirent *de;
...
void setOperations(struct fuse_operations& oper) {
    oper.getattr    = xmp_getattr;
    oper.getattr	= xmp_getattr;
    oper.access		= xmp_access;
    oper.readlink	= xmp_readlink;
    oper.readdir	= xmp_readdir;
    ...
    oper.open		= xmp_open;
    oper.read		= xmp_read;
    oper.write		= xmp_write;
    oper.statfs		= xmp_statfs;
    oper.release	= xmp_release;
    oper.fsync		= xmp_fsync;
#ifdef HAVE_POSIX_FALLOCATE
    oper.fallocate	= xmp_fallocate;
#endif
#ifdef HAVE_SETXATTR
